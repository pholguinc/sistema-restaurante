                ...
                <div class="content">
                    <div class="block">
                        <div class="block-header block-header-default d-flex justify-content-between align-items-center mr-10 pt-30">
                            <h2 class="block-title">Gestion de usuarios</h2>
                            <div class="ml-auto">
                                <button type="button" id="btnAñadir" class="btn btn-alt-primary mb-0" data-toggle="modal" data-target="#modal_usuarios">Añadir</button>
                            </div>
                        </div>

                        <div id="modal_usuarios" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-center" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                    ...
                                    <form method="post" id="usuarios_form">
                                        <div class="block-content">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12">Seleccionar empleado:</label>
                                                <div class="col-md-12">
                                                    <select class="form-control" id="cdx_empleado" name="cdx_empleado">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12">Nombre Usuario:</label>
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control" id="nombreUsu" name="nombreUsu" placeholder="" required>
                                                </div>
                                            </div>
