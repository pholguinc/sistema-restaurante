...
?>
    ...
    <body>
                ...
                <div class="content">
                    <div class="block">
                        <div class="block-header block-header-default d-flex justify-content-between align-items-center mr-10 pt-30">
                            <h2 class="block-title">Listado de insumos</h2>
                            <div class="ml-auto">
                                <button type="button" id="btnAñadir" class="btn btn-alt-primary mb-0" data-toggle="modal" data-target="#modal_insumos">Añadir</button>
                            </div>
                        </div>

                        <div id="modal_insumos" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-center" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                            <div class="modal-dialog modal-dialog-center  role=" document">
                                <div class="modal-content">
                                    ...
                                    <form method="post" id="insumos_form">
                                        <div class="block-content">
                                            <input type="hidden" name="id_insumos" id="id_insumos">
                                            ...
                                            <div class="form-group row"><label class="col-12">Descrpción:</label>
                                                <div class="col-12">
                                                    <textarea class="form-control" id="descripcion" name="descripcion" rows="2" placeholder="Descripcion.." style="resize: none;"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12">Presentación:</label>
                                                <div class="col-md-12">
                                                    <select class="form-control" id="cbx_presentacion" name="cbx_presentacion">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <select class="form-control" id="cbx_proveedor" name="cbx_proveedor">
                                                    </select>
                                                </div>
                                            </div>
        ...
        <script type="text/javascript" src="insumos.js"></script>
    </body>
