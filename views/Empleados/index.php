                ...
                <div class="content">
                    <div class="block">
                        <div class="block-header block-header-default d-flex justify-content-between align-items-center mr-10 pt-30">
                            <h2 class="block-title">Listado de empleados</h2>
                            <div class="ml-auto">
                                    ...
                                    <form method="post" id="empleados_form">
                                        <div class="block-content">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control" id="dni" name="dni" placeholder="756984312">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control" id="correo" name="correo" placeholder="ejemplos@gmail.com">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" class="form-control" id="telefono" name="telefono" placeholder="987654321...">
                                                </div>
                                            </div>
