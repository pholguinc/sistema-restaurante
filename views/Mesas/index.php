                    ...
                    <div class="content ">
                        <div class="block">
                            <div class="block-header block-header-default d-flex justify-content-between align-items-center mr-10 pt-30">
                                <h2 class="block-title">Listado de Mesas</h2>
                                <div class="ml-auto">
                                    <button type="button" id="btnAñadirMesas" class="btn btn-alt-primary mb-0" data-toggle="modal" data-target="#modalMesas">Añadir</button>
                                </div>
                            </div>

                            <div id="modalMesas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-center" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                <div class="modal-dialog modal-dialog-center  role=" document">
                                    <div class="modal-content">
                                        <div class="block block-themed block-transparent mb-5">
                                            <div class="block-header bg-primary">
                                                <h3 class="block-title" id="modalTituloMesas" style="text-transform: uppercase;"></h3>
                                        ...
                                        <form method="post" id="mesasForm">
                                            <div class="block-content">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" id="nombreMesa" name="nombreMesa" placeholder="Nombre.." required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-12">Capacidad:</label>
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" id="capacidad" name="capacidad" placeholder="Canitdad..." required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-12">Pisos:</label>
                                                    <div class="col-md-12">
                                                        <select class="form-control" id="cbxPiso" name="cbxPiso">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-alt-secondary" data-dismiss="modal">Cerrar</button>
                                                    <button type="submit" name="action" value="add" id="btnGuardarMesa" class="btn btn-alt-success">
